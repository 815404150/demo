    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo Url::toRoute(['menu/menuupdate']) ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="user" id="user" placeholder="请输入用户名" value="<?php echo $data['user'] ?>">
                                <span class="p"></span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="password" name="pwd" placeholder="请输入密码" value="<?php echo $data['pwd'] ?>">
                            </td>
                        </tr>
                        <tr>
                            <th></th>
