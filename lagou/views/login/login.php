...
<div class="login-box">
	<h1>乐听音乐系统后台登录</h1>
	<form method="post" action="<?php echo Url::toRoute(['login/login']) ?>">
		<div class="name">
			<label>管理员账号：</label>
			<input type="text" name="user" id="" tabindex="1" autocomplete="off" />
		</div>
		<div class="password">
			<label>密  码：</label>
			<input type="password" name="pwd" maxlength="16" id="" tabindex="2"/>
		</div>
		<div class="remember">
